...
package com.io7m.cantoria.tests.modules.api;
...
public abstract class CModulesContract
{
  protected abstract CModuleLoaderType loader();
  ...
  @Test
  public final void testJavaBase()
    throws Exception
  {
    try (CModuleType m = this.loader().openPlatformModule("java.base")) {
      checkBase(m);
    }
  }

  @Test
  public final void testJavaBaseWeaklyCached()
    throws Exception
  {
    try (CModuleType m = CModuleWeaklyCaching.wrap(
      this.loader().openPlatformModule("java.base"))) {
      checkBase(m);
    }
  }

  @Test
  public final void testPlatformModules()
    throws Exception
  {
    Assertions.assertTrue(
      this.loader().listPlatformModules().contains("java.base"));
  }
}
