 ...
 * JLS 9, §13.4.8:
 *
 * <blockquote>Deleting a field from a class will break compatibility with any
 * pre-existing binaries that reference this field, and a NoSuchFieldError will
 * be thrown when such a reference from a pre-existing binary is linked. Only
 * private fields may be safely deleted from a widely distributed
 * class.</blockquote>
 */
...
@VavrEncodingEnabled
@Value.Immutable
public interface CChangeClassFieldRemovedPublicType
