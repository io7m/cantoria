 ...
 * binaries.</blockquote>
 *
 * This implementation chooses to believe that adding a provider is a
 * backwards-compatible "new feature" change according to semantic versioning.
 */

@CImmutableStyleType
@VavrEncodingEnabled
@Value.Immutable
public interface CChangeModuleServiceProvidedType
