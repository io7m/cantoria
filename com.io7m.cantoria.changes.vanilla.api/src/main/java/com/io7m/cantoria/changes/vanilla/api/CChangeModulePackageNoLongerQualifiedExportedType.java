...
/**
 * @see CChangeModulePackageNoLongerUnqualifiedExportedType
 */

@CImmutableStyleType
@VavrEncodingEnabled
@Value.Immutable
public interface CChangeModulePackageNoLongerQualifiedExportedType
  extends CChangeModuleType
{
  ...
  /**
   * @return The name of the module to which the package is exported
   */
