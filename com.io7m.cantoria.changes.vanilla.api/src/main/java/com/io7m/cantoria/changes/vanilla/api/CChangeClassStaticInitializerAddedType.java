 ...
 * JLS 9, §13.4.25:
 *
 * <blockquote>Adding, deleting, or changing a static initializer (§8.7) of a
 * class does not impact pre-existing binaries.</blockquote>
 */

@CImmutableStyleType
@VavrEncodingEnabled
@Value.Immutable
public interface CChangeClassStaticInitializerAddedType
