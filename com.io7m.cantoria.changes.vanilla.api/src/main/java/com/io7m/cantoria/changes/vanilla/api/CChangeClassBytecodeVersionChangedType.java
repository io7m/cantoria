...
/**
 * Changing the bytecode version is a binary-incompatible, but source-compatible
 * change.
 */
...
@VavrEncodingEnabled
@Value.Immutable
public interface CChangeClassBytecodeVersionChangedType
  extends CChangeClassType
{
  ...
  /**
   * @return The bytecode version of the old class
   */
  ...
  /**
   * @return The bytecode version of the new class
   */
